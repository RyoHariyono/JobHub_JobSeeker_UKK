-- ============================================
-- JOBHUB: INSERT JOBS DATA (AUTO COMPANY ID)
-- ============================================
-- Script ini akan otomatis mencari company ID berdasarkan nama
-- Jadi tidak perlu manual copy-paste UUID
-- ============================================
...
-- ============================================
-- STEP 2: INSERT 12 JOBS (AUTO COMPANY LOOKUP)
-- ============================================
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    '0fb56b74-cf6f-41a7-aeed-5b5676a3cab9'::uuid,  -- Google
    'Product Designer',
    'ui_ux',
    'full_time',
    'Surabaya, Indonesia',
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    'd23d6120-5668-403f-ae3e-78b2cb687b58'::uuid,  -- Microsoft
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    '89707f15-6adc-46c0-bd21-29888ed5f49b'::uuid,  -- Amazon
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    '547bc8d4-8eea-490f-a39a-5f7895cae850'::uuid,  -- Netflix
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    'dea289ad-6c26-4434-a097-a8ba7338eadc'::uuid,  -- Spotify
    'Vue.js Developer',
    'frontend',
    'contract',
