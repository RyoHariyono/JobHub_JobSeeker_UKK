-- ============================================
-- JOBHUB: RESET & INSERT JOBS DATA
-- ============================================
-- Script ini akan:
-- 1. Cek company IDs yang tersedia
-- 2. Hapus semua data jobs yang ada (RESET)
-- 3. Insert 12 jobs baru dengan requirements dan tags
-- ============================================

-- STEP 0: CEK COMPANY IDs DULU!
-- Run query ini dulu, copy UUID yang benar, lalu ganti di bawah:
-- SELECT id, name FROM companies ORDER BY name;

-- STEP 1: CLEAR EXISTING JOBS DATA
-- (Cascade akan auto-delete job_requirements dan job_tags)
...
-- ============================================
-- IMPORTANT: Sesuaikan company_id dengan yang ada di database Anda!
-- Cek dengan: SELECT id, name FROM companies;
...
BEGIN
  ...
  VALUES (
    '226d5dc1-19e5-4ef4-bb0e-d9a596a2e4e05',  -- Apple ID
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    'ofb56b74-cfef-41a7-aaed-8a5676a82ca69',  -- Google ID
    'Product Designer',
    'ui_ux',
    'full_time',
    'Surabaya, Indonesia',
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    'e67914fe-bb8a-4e61-a3b3-f4f73bd56cfb',  -- Meta ID
    'UI Designer',
    'ui_ux',
    'full_time',
    'Bandung, Indonesia',
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    'd23de120-5668-403f-ae3e-78b2cb6e67b8',  -- Microsoft ID
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    '8970f715-6edc-46c0-ba15-85881abe1ccc2',  -- Amazon ID
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    '847ba4d5-80ea-490f-a20a-5f7f99b0e860f',  -- Netflix ID
...
BEGIN
  INSERT INTO jobs (company_id, title, category, type, location, min_salary, max_salary, description, experience_required, job_level, capacity, posted_date, deadline_date, start_date, is_active)
  VALUES (
    'dee289ad-6c26-4434-a097-e8ba7338ead',  -- Spotify ID
    'Vue.js Developer',
    'frontend',
    'contract',
